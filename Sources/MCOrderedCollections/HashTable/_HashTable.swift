...
extension _HashTable {
    ...
    init(scale: Int, reservedScale: Int = 0) {
...
extension _HashTable {
    ...
    @inlinable
    @inline(__always)
    func read<R>(_ body: (_UnsafeHashTable) throws -> R) rethrows -> R {
    ...
    @inlinable
    @inline(__always)
    func update<R>(_ body: (_UnsafeHashTable) throws -> R) rethrows -> R {
        try _storage.withUnsafeMutablePointers { header, elements in
