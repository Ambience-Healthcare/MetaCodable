...
public extension OrderedDictionary.Elements {
    ...
    struct SubSequence {
        @usableFromInline
        var _base: OrderedDictionary
        @usableFromInline
        var _bounds: Range<Int>

        @inlinable
        @inline(__always)
        init(_base: OrderedDictionary, bounds: Range<Int>) {
            self._base = _base
            _bounds = bounds
        }
    }
...
public extension OrderedDictionary.Elements.SubSequence {
...
extension OrderedDictionary.Elements.SubSequence: Sequence {
    ...
    public struct Iterator: IteratorProtocol {
        ...
        @inlinable
        @inline(__always)
        init(_base: OrderedDictionary.Elements.SubSequence) {
            self._base = _base._base
            _end = _base._bounds.upperBound
            _index = _base._bounds.lowerBound
        }
