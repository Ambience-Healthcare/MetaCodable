...
extension OrderedDictionary {
    ...
    @inlinable
    mutating func _prepareForKeyingModify(
        _ key: Key,
        _ value: inout Value?
    ...
    @inlinable
    mutating func _prepareForDefaultedModify(
        _ key: Key,
    ...
    @inlinable
    mutating func _finalizeDefaultedModify(
...
public extension OrderedDictionary {
    ...
    func mapValues<T>(
        ...
        try OrderedDictionary<Key, T>(
            _uniqueKeys: _keys,
            values: ContiguousArray(_values.map(transform))
        )
    }
