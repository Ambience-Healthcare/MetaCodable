...
public extension OrderedSet {
    ...
    init(minimumCapacity: Int, persistent: Bool = false) {
        self.init()
        _reserveCapacity(minimumCapacity, persistent: persistent)
    }
}
...
public extension OrderedSet {
    ...
    mutating func reserveCapacity(_ minimumCapacity: Int) {
        _reserveCapacity(minimumCapacity, persistent: false)
    }
}
...
extension OrderedSet {
    ...
    /// - Complexity: O(`max(count, minimumCapacity)`)
    @inlinable
    mutating func _reserveCapacity(
        ...
        let requiredScale = _HashTable.scale(forCapacity: count)
