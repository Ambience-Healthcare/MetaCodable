...
public extension OrderedSet {
    ...
    struct UnorderedView {
        @usableFromInline
        var _base: OrderedSet

        @inlinable
        @inline(__always)
        init(_base: OrderedSet) {
            self._base = _base
        }
    }
...
public extension OrderedSet.UnorderedView {
...
public extension OrderedSet.UnorderedView {
    ...
    ///    implements high-quality hashing.
    @inlinable
    mutating func formUnion(_ other: __owned some Sequence<Element>) {
...
public extension OrderedSet.UnorderedView {
    ...
    ///    elements in `other`, if `Element` implements high-quality hashing.
    @inlinable
    mutating func formIntersection(
        _ other: some Sequence<Element>
    ) {
...
public extension OrderedSet.UnorderedView {
    ...
    ///    hashing.
    @inlinable
    mutating func formSymmetricDifference(
        _ other: __owned some Sequence<Element>
    ) {
...
public extension OrderedSet.UnorderedView {
    ...
    ///    `Element` implements high-quality hashing.
    @inlinable
    __consuming func subtracting(_ other: some Sequence<Element>) -> Self {
...
public extension OrderedSet.UnorderedView {
    ...
    func isEqualSet(to other: some Sequence<Element>) -> Bool {
        _base.isEqualSet(to: other)
    }
}
...
public extension OrderedSet.UnorderedView {
    ...
    ///    high-quality hashing.
    @inlinable
    func isSubset(of other: some Sequence<Element>) -> Bool {
        _base.isSubset(of: other)
    }
}
...
public extension OrderedSet.UnorderedView {
    ...
    ///    elements in `other`, if `Element` implements high-quality hashing.
    @inlinable
    func isSuperset(of other: some Sequence<Element>) -> Bool {
        _base.isSuperset(of: other)
    }
}
...
public extension OrderedSet.UnorderedView {
    ...
    ///    high-quality hashing.
    @inlinable
    func isStrictSubset(of other: some Sequence<Element>) -> Bool {
        _base.isStrictSubset(of: other)
    }
}
...
public extension OrderedSet.UnorderedView {
    ...
    ///    high-quality hashing.
    @inlinable
    func isStrictSuperset(of other: some Sequence<Element>) -> Bool {
        _base.isStrictSuperset(of: other)
    }
}
